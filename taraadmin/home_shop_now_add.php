...
$neelx="INSERT INTO `home_shopnow_image`(`id`, `post_date`,`title`, `image`,`url`, `status`) VALUES ('',NOW(),'$title','$img','$url','$status')";
...
<span class="glyphicon glyphicon-user"></span>&nbsp;Add Home Page Image <?php if(isset($signup_error)){ echo '<span style="color: red;" />'.$signup_error.'</span>';} ?></h4>
