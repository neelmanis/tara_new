...
(function (jQuery) {
    ...
    function CloudZoom(jWin, opts) {
        ...
        this.init = function () {
             ...
             */
            jQuerymouseTrap = jWin.parent().append(format("<div class='mousetrap' style='background-image:url(\""+ opts.transparentImage +"\");z-index:999;position:absolute;width:%0px;height:%1px;left:0px;top:0px;\'></div>", sImg.outerWidth(), sImg.outerHeight(), 0, 0)).find(':last');
            ...
            jQuerymouseTrap.bind('mouseenter', this, function (event) {
                ...
                zoomDiv = appendTo.append(format('<div id="cloud-zoom-big" class="cloud-zoom-big" style="display:none;position:absolute;left:500px;top:%1px;width:400px;height:%3px;background-image:url(\'%4\');z-index:99;border:solid 2px #ddd;"></div>', xPos, yPos, w, h, zoomImage.src)).find(':last');

                // Add the title from title tag.
                if (sImg.attr('title') && opts.showTitle) {
                    zoomDiv.append(format('<div class="cloud-zoom-title">%0</div>', sImg.attr('title'))).find(':last').css({"opacity": opts.titleOpacity,"padding":"20px;"});
                }
